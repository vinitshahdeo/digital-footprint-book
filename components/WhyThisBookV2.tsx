  ...
  return (
    <section className="py-16 md:py-28 px-6 bg-gradient-to-b from-slate-50/80 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        {/* V2 — Numbered Editorial + Quote side by side */}
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-stretch">
            ...
            {reasons.map((reason, index) => (
              ...
              >
                <div className="flex items-start gap-6 py-6">
                  <span className="text-4xl md:text-5xl font-extralight text-slate-200 group-hover:text-blue-200 transition-colors duration-300 tabular-nums leading-none pt-0.5 select-none">
                    {String(index + 1).padStart(2, '0')}
                  </span>
                  <div className="flex-1 pt-0.5">
                    <div className="flex items-center gap-3 mb-1.5">
                      <reason.icon className="w-4 h-4 text-blue-500" />
          ...
          >
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 md:p-10 flex flex-col justify-center w-full">
              ...
              <div className="relative z-10 text-center">
                ...
                >
                  <svg className="w-12 h-12 mx-auto text-blue-400 opacity-50" fill="currentColor" viewBox="0 0 32 32">
                    <path d="M10 8c-3.3 0-6 2.7-6 6v10h10V14h-6c0-2.2 1.8-4 4-4V8zm16 0c-3.3 0-6 2.7-6 6v10h10V14h-6c0-2.2 1.8-4 4-4V8z" />
                  </svg>
                </motion.div>
                <motion.p
                  className="text-lg md:text-xl font-medium text-white leading-relaxed mb-5"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                ...
                >
                  ...
                  <div className="h-px w-10 bg-gradient-to-l from-transparent to-purple-400"></div>
                </motion.div>
                <motion.p
                  className="text-sm text-slate-400 font-medium mb-6"
                ...
                >
                  <a
                    ...
                    className="inline-flex items-center gap-3 px-4 py-2 bg-white rounded-full border border-slate-200 hover:shadow-lg transition-all duration-200 group"
                  >
                    ...
                    <div className="flex items-center gap-2 ml-3">
                      <svg className="w-3.5 h-3.5 text-blue-500 opacity-60 group-hover:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3z" />
                        <path d="M17 11c0 2.76-2.24 5-5 5s-5-2.24-5-5H5c0 3.53 2.61 6.43 6 6.92V21h2v-3.08c3.39-.49 6-3.39 6-6.92h-2z" />
                      </svg>
                      <svg className="w-3.5 h-3.5 text-blue-500 opacity-60 group-hover:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
