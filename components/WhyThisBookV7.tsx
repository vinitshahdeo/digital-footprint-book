  ...
  return (
    <section className="py-16 md:py-28 px-6 bg-gradient-to-b from-slate-50/80 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        {/* V7 — Icon Row: Free-standing icons with vertical separators, Apple-style */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-0 mb-16 max-w-4xl mx-auto">
          {reasons.map((reason, index) => (
            ...
            >
              <div className="group cursor-default flex flex-col items-center text-center px-6 md:px-8 py-6 md:py-0">
                <div className="mb-4 relative">
                  <div className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center group-hover:border-blue-300 group-hover:bg-blue-50/50 transition-all duration-300">
                    <reason.icon className="w-4 h-4 text-slate-400 group-hover:text-blue-500 transition-colors duration-300" />
                  </div>
                </div>
                <h3 className="text-sm font-semibold text-slate-900 mb-0.5 group-hover:text-blue-600 transition-colors duration-200 whitespace-nowrap">
                  {reason.title}
                </h3>
              ...
              {index < reasons.length - 1 && (
                <div className="hidden md:block w-px h-12 bg-slate-200/80 flex-shrink-0" />
              )}
