...
import { Search, MousePointer, MessageCircle, Calendar, Globe } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <p className="text-[11px] font-semibold text-slate-600 mb-4 inline-flex items-center gap-2 pl-1 pr-3.5 py-1 bg-white/90 rounded-full border border-blue-100 shadow-sm backdrop-blur-sm">
            <span className="px-2 py-0.5 bg-slate-900 text-white text-[10px] font-mono font-bold rounded-full inline-flex items-center gap-1"><Globe className="w-2.5 h-2.5" />nslookup</span>
            no records found
          </p>
          ...
          >
            ...
            >
              <p className="text-base font-semibold text-slate-900 mb-2">
                You don't get a second first search
              </p>
              ...
              <ul className="space-y-3.5">
                ...
                >
                  ...
                  <span className="text-sm leading-relaxed">
                    <span className="font-semibold text-slate-900">Searchable</span> — Your name
                ...
                >
                  <span className="text-blue-600 font-bold text-lg">✓</span>
                  <span className="text-sm leading-relaxed">
                    <span className="font-semibold text-slate-900">Credible</span> — Links point to
                    real work
                  </span>
                </motion.li>
                <motion.li
                ...
                >
                  <span className="text-blue-600 font-bold text-lg">✓</span>
                  <span className="text-sm leading-relaxed">
                    <span className="font-semibold text-slate-900">Consistent</span> — Same identity
                    across platforms
                  </span>
                </motion.li>
                <motion.li
                ...
                >
                  <span className="text-blue-600 font-bold text-lg">✓</span>
                  <span className="text-sm leading-relaxed">
                    <span className="font-semibold text-slate-900">Authentic</span> — Represents who
                    you really are
                  </span>
                </motion.li>
              </ul>
