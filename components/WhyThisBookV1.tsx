  ...
  return (
    <section className="py-16 md:py-28 px-6 bg-gradient-to-b from-slate-50/80 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        {/* V1 — Bento Grid: Feature card + 3 smaller cards */}
        <div className="grid md:grid-cols-3 gap-4 mb-16">
          {/* Feature card — spans 2 cols, dark bg */}
          <motion.div
            className="md:col-span-2 relative bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-8 md:p-10 group cursor-default overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-2">{reasons[0].title}</h3>
                <p className="text-slate-400 text-sm leading-relaxed">{reasons[0].description}</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            className="relative bg-white rounded-2xl border border-slate-200/60 p-7 group cursor-default overflow-hidden hover:border-slate-300 transition-all duration-300"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <p className="text-slate-500 text-sm leading-relaxed">{reasons[1].description}</p>
          ...
          >
            ...
            <p className="text-slate-500 text-sm leading-relaxed">{reasons[2].description}</p>
            <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-500 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </motion.div>

          {/* Fourth card — spans 2 cols */}
          <motion.div
            className="md:col-span-2 relative bg-white rounded-2xl border border-slate-200/60 p-7 group cursor-default overflow-hidden hover:border-slate-300 transition-all duration-300"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center gap-5">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm leading-relaxed">{reasons[3].description}</p>
              </div>
            </div>
            <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-500 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </motion.div>
