    ...
    <section className="py-16 sm:py-20 md:py-28 px-6 bg-gradient-to-b from-slate-50 via-slate-100/50 to-slate-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <motion.p
            className="text-[11px] font-semibold text-slate-600 mb-4 inline-flex items-center gap-2 pl-1 pr-3.5 py-1 bg-white/90 rounded-full border border-blue-100 shadow-sm backdrop-blur-sm"
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
          >
            <span className="px-2 py-0.5 bg-slate-900 text-white text-[10px] font-mono font-bold rounded-full inline-flex items-center gap-1"><Bot className="w-2.5 h-2.5" />whoami</span>
            prompt: you
          </motion.p>
          ...
          >
            <p className="text-lg text-slate-600 max-w-3xl mx-auto mb-3">
              AI agents are already researching candidates.{' '}
              <span className="text-slate-900 font-medium">What will they find about you?</span>
            </p>
          </motion.div>

          {/* Try it yourself — LLM links */}
          <motion.div
            ...
            <div className="flex flex-wrap justify-center items-center gap-2">
              ...
              >
                ...
                >
                  ...
                  <defs>
                    <clipPath id="perplexity_clip_ask">
                      <path fill="#fff" d="M0 0h24v24H0z" />
                    </clipPath>
                  </defs>
                </svg>
