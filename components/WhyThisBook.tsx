      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-[11px] font-semibold text-slate-600 mb-4 inline-flex items-center gap-2 pl-1 pr-3.5 py-1 bg-white/90 rounded-full border border-blue-100 shadow-sm backdrop-blur-sm">
            <span className="px-2 py-0.5 bg-slate-900 text-white text-[10px] font-mono font-bold rounded-full inline-flex items-center gap-1"><Shield className="w-2.5 h-2.5" />--strict</span>
            no fluff mode
          </p>
          ...
          >
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 md:p-10 flex flex-col justify-center w-full">
              ...
              <div className="relative z-10 text-center">
                ...
                >
                  <svg
                    className="w-12 h-12 mx-auto text-blue-400 opacity-50"
                    fill="currentColor"
                    viewBox="0 0 32 32"
                  >
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 ml-3">
                      <svg
                        className="w-3.5 h-3.5 text-blue-500 opacity-60 group-hover:opacity-100 transition-opacity"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                      >
